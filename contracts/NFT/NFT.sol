...
contract NFT is IBEP721 {
    ...
    /**
     * Similar to previous safeTransferFrom function except that a message is sent to the smart-contract receiver to confirm that it handles
     * BEP721 tokens. Sending data to another smart-contract is an application-specific.
     *
     * @param from - Address of the NFT token's sender
     * @param to - Address of the NFT token's receiver
